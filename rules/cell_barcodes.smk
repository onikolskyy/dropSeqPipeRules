...
rule fast_whitelist:
    ...
    shell: "python /dropSeqPipe/scripts/whitelist.py --fastq={input} --csv={output} --regex='(?P<cell_1>.{{{params.cell_barcode_length}}})(?P<umi_1>.{{{params.umi_barcode_length}}})' --threads=15 --cells={params.num_cells}"
