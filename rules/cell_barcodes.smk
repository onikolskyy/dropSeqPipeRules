...
rule fast_whitelist:
    ...
    shell: "python ../scripts/whitelist.py --fastq={input} --csv={output} --regex='(?P<cell_1>.{{params.cell_barcode_length}})(?P<umi_1>.{{params.umi_barcode_length}})' --N_THREADS=60 --N_CELLS={params.num_cells}"
