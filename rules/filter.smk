...
rule cutadapt_R1:
    ...
    benchmark:'{results_dir}/benchmarks/cutadapt_R1.{sample}.txt'
...
rule cutadapt_R2:
    ...
    benchmark:
        '{results_dir}/benchmarks/cutadapt_R2.{sample}.txt'
    conda: '../envs/cutadapt.yaml' 
    shell:
        """cutadapt\
        -a file:{input.adapters}\
...
rule clean_cutadapt:
    ...
    benchmark:
        '{results_dir}/benchmarks/clean_cutadapt.{sample}.txt'
    output:
...
rule repair:
    ...
    benchmark:
        '{results_dir}/benchmarks/repair.{sample}.txt'
    params:
...
rule detect_barcodes:
    ...
    benchmark:
        '{results_dir}/benchmarks/detect_barcodes.{sample}.txt'
...
rule plot_adapter_content:
    ...
    benchmark:
        '{results_dir}/benchmarks/plot_adapter_content.txt'
    output:
...
rule multiqc_cutadapt_barcodes:
    ...
    benchmark:
        '{results_dir}/benchmarks/multiqc_cutadapt_barcodes.txt'
    wrapper:
        '0.21.0/bio/multiqc'
...
rule multiqc_cutadapt_RNA:
    ...
    benchmark:
        '{results_dir}/benchmarks/multiqc_cutadapt_RNA.txt'
    wrapper:
        '0.21.0/bio/multiqc'
