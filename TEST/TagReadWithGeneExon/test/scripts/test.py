...
for ref, group in grouped:
    ...
    single_block = single_block.merge(LFs, left_on="LF", right_index=True).sort_vlaues(("read","gene"))
    multiple_blocks = multiple_blocks.merge(LFs, left_on="LF", right_index=True).sort_vlaues(("read","gene"))
