...
rule create_refFlat:
    ...
    params:
        memory=config['LOCAL']['memory'],
        temp_directory=config['LOCAL']['temp-directory']
    benchmark: '/output/results/benchmarks/create_refFlat.{species}_{build}_{release}.txt'
    output:
        "/output/results/{species}_{build}_{release}/curated_annotation.refFlat"
    conda: '../envs/dropseq_tools.yaml'
    shell:
...
rule create_intervals:
    ...
    benchmark: '/output/results/benchmarks/create_intervals.{ref_path}.{species}_{build}_{release}.txt'
    output:
...
rule get_genomeChrBinNbits:
    ...
    benchmark: '/output/results/benchmarks/get_genomeChrBinNbits.txt'
    run:
        """
